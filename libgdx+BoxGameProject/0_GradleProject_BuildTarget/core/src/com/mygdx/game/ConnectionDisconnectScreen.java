 ...
 * 
 * Source File: ConnectionDisconnectScreen.java
 * 
...
public class ConnectionDisconnectScreen  implements Screen
{
	boolean showScreen;
	...
	public ConnectionDisconnectScreen( BoxGame game, SpriteBatch inBatch )
	{
		this.game = game;
		this.batch = inBatch;
	...
	public void show() 
	{
		game.setBufferColor(0.0f, .30f, 0.0f);	
	...
	public void render(float delta) 
	{
		...
		{
			font.setScale( 2);
			font.draw( batch, "Disconnected from opponent...", 100, 300);
